...
mysqldump.exe -e -uroot -poctober181986* -hlocalhost bank_cheque cashdisbursement > C:\webtis\databasebackup\cashdisbursement.sql
mysqldump.exe -e -uroot -poctober181986* -hlocalhost bank_cheque cashdisbursementreport > C:\webtis\databasebackup\cashdisbursementreport.sql
mysqldump.exe -e -uroot -poctober181986* -hlocalhost bank_cheque checkissued > C:\webtis\databasebackup\checkissued.sql
mysqldump.exe -e -uroot -poctober181986* -hlocalhost bank_cheque checkissuedreport > C:\webtis\databasebackup\checkissuedreport.sql
mysqldump.exe -e -uroot -poctober181986* -hlocalhost bank_cheque collectiondeposit > C:\webtis\databasebackup\collectiondeposit.sql
mysqldump.exe -e -uroot -poctober181986* -hlocalhost bank_cheque collectiondepositreport > C:\webtis\databasebackup\collectiondepositreport.sql
